...
public class PropertyModelGroupController {
     ...
     * @apiParam (请求体) {Int} groupType 属性模板组类型（-1-默认分组；0-工程项目；1-设备；2-工作流）
     ...
     * @apiSuccess (返回结果) {Int} groupType 属性模板组类型（-1-默认分组；0-工程项目；1-设备；2-工作流）
     ...
     * @apiSuccess (返回结果) {Int} groupList.groupType 属性模板组类型（-1-默认分组；0-工程项目；1-设备；2-工作流）
