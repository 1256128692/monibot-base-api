...
public class ProjectStatisticsController {
    ...
    /**
     * @api {POST} /QueryCompanyMonitorPointInfoList  查询公司下监测点信息列表
     * @apiVersion 1.0.0
     * @apiGroup 工程下首页统计模块
     * @apiName QueryCompanyMonitorPointInfoList
     * @apiDescription 查询公司下监测点信息列表
     * @apiParam (请求体) {Int} companyID 公司ID
    ...
    @RequestMapping(value = "QueryCompanyMonitorPointInfoList", method = RequestMethod.POST, produces = DefaultConstant.JSON, consumes = DefaultConstant.JSON)
    public Object queryCompanyMonitorPointInfoList(@Validated @RequestBody QueryCompanyMonitorPointInfoParam pa) {
        return projectStatisticsService.queryCompanyMonitorPointInfoList(pa);
    }
