...
public interface TbMonitorItemMapper extends BaseMapper<TbMonitorItem> {
    ...
    IPage<MonitorItem4Web> queryPage(Page<MonitorItem4Web> page, Integer companyID, Integer projectID, Byte createType, String queryCode, Integer monitorType, List<Integer> idList, Boolean companyItem);
