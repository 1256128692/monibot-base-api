...
import cn.shmedo.monitor.monibotbaseapi.model.response.video.VideoDeviceSourceBaseInfo;
...
public interface TbVideoDeviceSourceMapper {
    ...
    List<VideoDeviceSourceBaseInfo> selectByDeviceSerialList(List<String> deviceSerialList);
}