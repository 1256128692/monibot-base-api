...
public class ThematicRainWaterDataInfo {
     ...
     */
    @SneakyThrows
    public Map<String, Object> toMaxDataMap(final Integer key, final DateTimeFormatter formatter) {
        Double value;
        switch (key) {
        ...
        return Map.of("key", key, "time", DateUtil.format(time, formatter), "value", value);
    }
}
